            ...
            <div class="col-md-3">
                <div class="card card-product-grid">
                    <a href="{{route('product.show', $product->slug)}}" class="img-wrap img-fluid"> <img
                            class="img-fluid m-1 rounded" src="{{ $product->getFirstMediaUrl(config('shopper.system.storage.disks.uploads')) }}">
                    </a>
        ...
        <div class="row">
            ...
            <div class="col-md-2 col-6">
                <figure class="box item-logo">
                    <a href="#"><img src="{{$category->getFirstMediaUrl(config('shopper.system.storage.disks.uploads'))}}"
